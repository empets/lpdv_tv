                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 16.w),
                        SvgPicture.asset(Assets.images.iconHome.iconNotification),
                        SizedBox(width: 7.w),
                        Container(
              ...
              Container(
                ...
                child: Column(
                  ...
                  ...List.generate(4, (index)=>    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border(
                          top: index == 0 ? BorderSide(
                            color: MyColors.primaryGray.withValues(alpha: 0.7),
                          ) : BorderSide.none,
                          bottom: BorderSide(
                            color: MyColors.primaryGray.withValues(alpha: 0.7),
                          ),
                      ...
                      child: Text("13h30 Heure de Gloire", style: GoogleFonts.inter(
                            color: MyColors.primaryGray,
                            fontWeight: FontWeight.w500,
                            fontSize: 14.sp,
                          ),),
